...
flags.DEFINE_string(
    "test_data",
    "C:/Users/Zzlmyself/PycharmProjects/PMSM/PMSM_test1.csv",
    "Path to the test data.")
flags.DEFINE_string(
    "predict_data",
    "C:/Users/Zzlmyself/PycharmProjects/PMSM/PMSM_predict1.csv",
...
def model_fn(features, targets, mode, params):
  ...
  #forth_hidden_layer=tf.contrib.layers.relu(third_hidden_layer,10)
  ...
  predictions_dict = {"degress": predictions}
...
def main(unused_argv):
  ...
  # Fit
  nn.fit(x=training_set.data, y=training_set.target, steps=50000)
  ...
  for i, p in enumerate(predictions):
    print("Prediction %s: %s" % (i + 1, p["degress"]))
